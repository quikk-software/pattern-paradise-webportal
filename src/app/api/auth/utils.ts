...
export async function refreshAccessToken(token: any) {
  try {
    ...
    return {
      ...
      acceptedTermsOn: user?.acceptedTermsOn ? new Date(user.acceptedTermsOn) : undefined,
      acceptedPrivacyOn: user?.acceptedPrivacyOn ? new Date(user.acceptedPrivacyOn) : undefined,
      theme: user?.theme,
