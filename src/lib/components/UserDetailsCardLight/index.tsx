    ...
    <Card className="group relative overflow-hidden border shadow-sm transition-all duration-300 hover:shadow-md">
      ...
      <div className="relative aspect-[4/1] w-full overflow-hidden">
        {user.bannerImageUrl ? (
          ...
          <div
            className={`h-full w-full bg-gradient-to-r opacity-30 ${THEME_FROM_BG_CLASSES[user.theme]} ${THEME_VIA_BG_CLASSES[user.theme]} ${THEME_TO_BG_CLASSES[user.theme]}`}
          />
        )}
          ...
          <div className="mt-4 space-y-3">
            {hasSocialLinks && (
              <div className="flex flex-wrap gap-2">
                {user.instagramRef && (
                  ...
                  >
                    <Badge variant="outline" className="border-pink-100 bg-transparent text-foreground">
                ...
                {user.tiktokRef && (
                  <a
                    ...
                    onClick={(e) => e.stopPropagation()}
                  >
                    <Badge variant="outline" className="border-slate-100 bg-transparent text-foreground">
            ...
            {!isMe && (
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                {isLoggedIn && (
                  <Button
                    className={`group/btn relative ${THEME_BG_CLASSES[user.theme]} overflow-hidden text-primary-foreground transition-all duration-300 hover:shadow-sm`}
