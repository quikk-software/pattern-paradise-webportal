            ...
            <div className="w-full space-y-4 pt-2">
              ...
              {!isMe && (
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  {isLoggedIn && (
                    <Button
                      className={`group/btn relative ${THEME_BG_CLASSES[user.theme]} hover:${THEME_BG_CLASSES[user.theme]} focus:${THEME_BG_CLASSES[user.theme]} overflow-hidden bg-primary text-primary-foreground transition-all duration-300 hover:shadow-sm`}
