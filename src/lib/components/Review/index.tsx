...
export default function Review({ isOpen, testingId, skipRating = false }: ReviewProps) {
  ...
  return (
    <Card className="flex flex-col gap-8">
      <CardHeader className="flex flex-col gap-4 items-center mt-4">
        <MessageCircleHeartIcon className="w-20 h-20" />
        <CardTitle>Leave a Review</CardTitle>
        <CardTitle className="text-sm font-medium">
          You can add a Review for this pattern here! Choose if you want to like or dislike below
          and leave a message and images.
        </CardTitle>
      </CardHeader>
