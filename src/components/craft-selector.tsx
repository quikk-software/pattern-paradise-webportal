...
export function CraftSelector({ selectedCraft, onCraftChange }: CraftSelectorProps) {
  return (
    <RadioGroup value={selectedCraft} onValueChange={onCraftChange} className="flex space-x-4">
      <div className="flex items-center space-x-2">
        <RadioGroupItem value="Crocheting" id="crocheting" />
        <Label htmlFor="crocheting" className="cursor-pointer">
          Crocheting
        </Label>
      </div>
      <div className="flex items-center space-x-2">
        <RadioGroupItem value="Knitting" id="knitting" />
        <Label htmlFor="knitting" className="cursor-pointer">
          Knitting
        </Label>
      </div>
    </RadioGroup>
