          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
              ...
              <AccordionContent className="pb-4 space-y-4">
                <div>
                  <p>
                    ...
                    royalty-free license to use it for the limited purpose of operating and
                    promoting the platform. This includes activities such as displaying your content
                    on listings, featuring it in search previews, or sharing it in marketing formats
                    ...
                    distribute your pattern files themselves. Our use of your content is always
                    within the context of promoting your listing or the overall platform, not for
                    independent commercial gain.
                  </p>
                </div>
                <PracticalExample>
              ...
              <AccordionContent className="pb-4 space-y-4">
                <div>
                  <p>
                    ...
                    systems like search engines or social media platforms handle cached or
                    previously indexed content, which may remain visible beyond our reach.
                  </p>
                </div>
                <PracticalExample>
            ...
            <AccordionItem value="removal-of-contributions" className="border rounded-lg px-4">
              ...
              <AccordionContent className="pb-4 space-y-4">
                <div>
                  <p>
                    You can remove your content anytime. We may also remove content that violates
                    our terms or could negatively impact the platform or its users. We do not remove
                    ...
                    the issue. If we do not receive a response within a reasonable period of time,
                    we reserve the right to moderate or remove the content without further notice.
                  </p>
                </div>
                <PracticalExample>
                  ...
                  don&apos;t hear back in a reasonable timeframe, we may need to remove it to
            ...
            <AccordionItem value="payment-policy" className="border rounded-lg px-4">
              ...
              <AccordionContent className="pb-4 space-y-4">
                ...
                <PracticalExample>
                  ...
                  downloads the file, the purchase is final — just like opening a digital book or
                  PDF. Since the content is immediately accessible and non-returnable, we can&apos;t
                  offer refunds after download.
                </PracticalExample>
              </AccordionContent>
            </AccordionItem>
              ...
              <AccordionContent className="pb-4 space-y-4">
                <div>
                  <p>
                    ...
                    third-party sites. Accessing such sites is at your own discretion, and we are
                    not responsible for any issues arising from their use, including but not limited
                    to data handling, terms of service, or product quality.
                  </p>
                </div>
                <PracticalExample>
                  If you follow a link from Pattern Paradise to another website — for example, to
                  buy a yarn kit or read more about a featured product — keep in mind that
                  you&apos;re now interacting with that external site, not us. Be sure to review
                  their terms and policies, especially when making a purchase or sharing personal
                  information.
                </PracticalExample>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="site-management" className="border rounded-lg px-4">
              ...
              <AccordionContent className="pb-4 space-y-4">
                <div>
                  <p>
                    We reserve the right to monitor activity on the platform and to remove or
                    restrict content as necessary to maintain a safe, respectful, and functional
                    environment. However, content is not removed arbitrarily. Actions we take under
                    this policy are consistent with the terms outlined in sections such as
                    Contribution License, Removal of Contributions, and Reviews. In general, we will
                    attempt to resolve issues through communication whenever appropriate and reserve
                    intervention for cases involving serious violations, harm to users, or legal
                    risks.
                  </p>
                </div>
                <PracticalExample>
            ...
            <AccordionItem value="copyright-infringements" className="border rounded-lg px-4">
              ...
              <AccordionContent className="pb-4 space-y-4">
                <div>
                  <p>
                    We comply with copyright law. You may report suspected violations, but must do
                    so truthfully. This includes reporting patterns or content that may infringe on
              ...
              <AccordionContent className="pb-4 space-y-4">
                <div>
                  <p>
                    ...
                    including backup and recovery processes. While we take reasonable steps to
                    protect and preserve data integrity, we are not liable for any data loss or
                    corruption that occurs due to technical failures, user actions, or factors
                    beyond our control. Users remain responsible for maintaining their own copies of
                    important information and content uploaded to the platform.
                  </p>
                </div>
                <PracticalExample>
                  We regularly back up listings and user profiles as part of running the platform,
                  but we recommend keeping your own backup of any patterns or key information — just
                  to be safe.
                </PracticalExample>
              </AccordionContent>
            </AccordionItem>
