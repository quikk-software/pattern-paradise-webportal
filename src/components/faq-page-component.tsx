        ...
        >
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              enthusiasts. We provide a platform for designers to sell their unique patterns and for
              buyers to discover a wide range of high-quality, handmade designs. We also offer
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              We charge a 5% fee on the gross value of each pattern sold. This fee helps us maintain
              and improve our platform, develop new collaboration tools, and ensure the quality of
              patterns shared in our community. We also offer a{' '}
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              A pattern is a detailed set of instructions for creating handmade items using crochet
              or knitting techniques. It includes step-by-step directions, stitch counts,
          ...
          <AccordionItem value="item-6">
            ...
            <AccordionContent>
              ...
              visibility, promote patterns, and attract more creators and buyers to our platform. We
              also offer innovative collaboration tools for pattern testing and refinement.
            </AccordionContent>
          </AccordionItem>
